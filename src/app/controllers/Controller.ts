...
import { TDocument, TSuspendableDocument, handleQuery } from '@/utils/mongoose'
...
export class SuspendableController<I> extends Controller<I> {
...
export class IndelibleController<I> extends Controller<I> {
